...
final class I18n
{
    ...
    private static function dictionary(): array
    {
        return [
            ...
            'property.force_nightly_price' => ['fr' => 'Forcer le prix de la nuit (TTC)', 'en' => 'Force the nightly price (tax incl.)'],
            'property.force_nightly_price_hint' => ['fr' => "Prix TTC payé par le client, par nuit. Ne peut pas être inférieur au tarif Lodgify (avant commission).", 'en' => "Tax-inclusive price paid by the client, per night. Cannot be lower than the Lodgify rate (before commission)."],
            'property.force_nightly_price_adjusted' => ['fr' => 'Le prix saisi était inférieur au minimum autorisé : il a été ajusté au tarif Lodgify minimum.', 'en' => 'The entered price was below the allowed minimum: it was adjusted to the minimum Lodgify rate.'],
