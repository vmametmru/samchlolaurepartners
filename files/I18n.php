...
final class I18n
{
    ...
    private static function dictionary(): array
    {
        return [
            ...
            'calendar.show_location' => ["fr" => "Afficher l'Emplacement", 'en' => 'Show location'],
            'calendar.filter_location_all' => ['fr' => 'Tous les emplacements', 'en' => 'All locations'],
            'calendar.location_legend_title' => ['fr' => 'Légende des emplacements :', 'en' => 'Location legend:'],
            ...
            'calendar.no_client_email' => ['fr' => 'Pas de Email', 'en' => 'No Email'],
            'calendar.no_client_phone' => ['fr' => 'Pas de Téléphone', 'en' => 'No Phone'],
            ...
            'calendar.create_requests' => ['fr' => 'Créer les demandes', 'en' => 'Create the requests'],
            ...
            'calendar.requests_created' => ['fr' => 'Les demandes ont bien été créées. Elles sont disponibles dans votre tableau de bord, dans « Réservations ».', 'en' => 'The requests have been created. They are available in your dashboard, under "Reservations".'],
            'share.whatsapp' => ['fr' => '💬 Partager sur WhatsApp', 'en' => '💬 Share on WhatsApp'],
            'share.copy_link' => ['fr' => '🔗 Copier le lien', 'en' => '🔗 Copy link'],
            'share.link_copied' => ['fr' => '✅ Lien copié', 'en' => '✅ Link copied'],
            'share.whatsapp_message' => ['fr' => 'Voici le lien de votre demande de réservation : ', 'en' => 'Here is the link to your booking request: '],
            'share.request_label' => ['fr' => 'Demande #%s', 'en' => 'Request #%s'],
            ...
            'property.tab_availability_only' => ['fr' => 'Disponibilités', 'en' => 'Availability'],
            ...
            'property.last_search_title' => ['fr' => 'Dernière recherche', 'en' => 'Last search'],
            'property.last_search_cta' => ['fr' => 'Faire une demande avec ces infos', 'en' => 'Make a request with this info'],
            'property.last_search_dates' => ['fr' => 'Dates', 'en' => 'Dates'],
            'property.last_search_guests' => ['fr' => 'Voyageurs', 'en' => 'Travelers'],
            'property.last_search_nationality' => ['fr' => 'Nationalité', 'en' => 'Nationality'],
            'property.last_search_name' => ['fr' => 'Nom', 'en' => 'Name'],
            'property.last_search_email' => ['fr' => 'Email', 'en' => 'Email'],
            'property.last_search_phone' => ['fr' => 'Téléphone', 'en' => 'Phone'],
            'property.last_search_message' => ['fr' => 'Message', 'en' => 'Message'],
            'property.last_search_mismatch_title' => ['fr' => 'Ces informations ne correspondent pas à ce logement', 'en' => 'This information does not match this property'],
            'property.last_search_mismatch_intro' => ['fr' => "Les dates et/ou le nombre de voyageurs de votre dernière recherche ne sont pas disponibles pour ce logement. Merci de les ajuster ci-dessous.", 'en' => 'The dates and/or number of travelers from your last search are not available for this property. Please adjust them below.'],
            'property.last_search_mismatch_arrival' => ['fr' => "Date d'arrivée", 'en' => 'Check-in date'],
            'property.last_search_mismatch_departure' => ['fr' => 'Date de départ', 'en' => 'Check-out date'],
            'property.last_search_mismatch_adults' => ['fr' => 'Adultes', 'en' => 'Adults'],
            'property.last_search_mismatch_children_3to12' => ['fr' => 'Enfants (3-12 ans)', 'en' => 'Children (3-12 years)'],
            'property.last_search_mismatch_children_under3' => ['fr' => 'Bébés (< 3 ans)', 'en' => 'Babies (< 3 years)'],
            'property.last_search_mismatch_dates_error' => ['fr' => 'Ces dates ne sont pas disponibles pour ce logement.', 'en' => 'These dates are not available for this property.'],
            'property.last_search_mismatch_guests_error' => ['fr' => 'Ce logement peut accueillir au maximum %d personne(s) (adultes + enfants de 3 ans et plus).', 'en' => 'This property can accommodate a maximum of %d guest(s) (adults + children aged 3 and over).'],
            'property.last_search_mismatch_continue' => ['fr' => 'Continuer', 'en' => 'Continue'],
            'property.last_search_mismatch_cancel' => ['fr' => 'Annuler', 'en' => 'Cancel'],
            ...
            'property.no_client_email' => ['fr' => 'Pas de Email', 'en' => 'No Email'],
            'property.no_client_phone' => ['fr' => 'Pas de Téléphone', 'en' => 'No Phone'],
            ...
            'property.create_request' => ['fr' => 'Créer la demande', 'en' => 'Create the request'],
            ...
            'property.request_created' => ['fr' => 'La demande a bien été créée. Elle est disponible dans votre tableau de bord, dans « Réservations ».', 'en' => 'The request has been created. It is available in your dashboard, under "Reservations".'],
