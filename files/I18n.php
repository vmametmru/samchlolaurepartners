...
final class I18n
{
    ...
    private static function dictionary(): array
    {
        return [
            ...
            'property.force_nightly_price_hint' => ['fr' => "Prix TTC payé par le client, pour l'ensemble du séjour. Ne peut pas être inférieur au tarif payé à Sam Chlo Laure (avant commission).", 'en' => "Tax-inclusive price paid by the client, for the whole stay. Cannot be lower than the rate paid to Sam Chlo Laure (before commission)."],
            ...
            'property.force_price_lodgify_label' => ['fr' => 'Prix Sam Chlo Laure (Lodgify), avant commission', 'en' => 'Sam Chlo Laure rate (Lodgify), before commission'],
            ...
            'property.force_extra_person_price_hint' => ['fr' => "Prix TTC payé par le client pour les personne(s) supplémentaire(s), pour l'ensemble du séjour. Ne peut pas être inférieur au tarif payé à Sam Chlo Laure (avant commission).", 'en' => "Tax-inclusive price paid by the client for the extra guest(s), for the whole stay. Cannot be lower than the rate paid to Sam Chlo Laure (before commission)."],
