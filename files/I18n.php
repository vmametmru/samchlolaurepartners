...
final class I18n
{
    ...
    private static function dictionary(): array
    {
        return [
            ...
            'property.force_nightly_price_hint' => ['fr' => "Prix TTC payé par le client, par nuit. Ne peut pas être inférieur au tarif payé à Sam Chlo Laure (avant commission).", 'en' => "Tax-inclusive price paid by the client, per night. Cannot be lower than the rate paid to Sam Chlo Laure (before commission)."],
