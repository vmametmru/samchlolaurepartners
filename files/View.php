...
final class View
{
    ...
    public static function emailTemplateVariableCatalog(): array
    {
        return [
            ...
            ['key' => 'commission_partenaire', 'description' => 'Estimation de la commission du partenaire déjà comprise dans le tarif (information partenaire uniquement, jamais ajoutée au total du client)', 'partnerOnly' => true],
