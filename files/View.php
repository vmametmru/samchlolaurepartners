...
final class View
{
    ...
    public static function emailTemplateVariableCatalog(): array
    {
        return [
            ...
            ['key' => 'tarif_hebergement', 'description' => 'Tarif du logement seul (déjà tel qu\'affiché sur la fiche du bien, commission du partenaire incluse), avant frais de ménage et personnes supplémentaires', 'partnerOnly' => false],
            ...
            ['key' => 'tarif_total', 'description' => 'Tarif hébergement + ménage + personnes supplémentaires (hors taxe touristique)', 'partnerOnly' => false],
            ...
            ['key' => 'tarif_normal', 'description' => 'Identique à {{tarif_hebergement}}', 'partnerOnly' => false],
            ['key' => 'commission_partenaire', 'description' => 'Estimation de la commission du partenaire calculée sur Tarif Client + Personnes Supplémentaires (jamais sur le ménage), déjà comprise dans le tarif (information partenaire uniquement, jamais ajoutée au total du client)', 'partnerOnly' => true],
