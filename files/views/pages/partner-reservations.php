  ...
  <div class="card overflow-hidden">
    <table class="table">
      ...
      <?php else: foreach ($reservations as $reservation): $status = (string) $reservation['status']; $rid = (int) $reservation['id']; ?>
        <tr>
          <td><a class="text-link" href="/partner/reservations/<?= $rid ?>"><?= \App\View::e($reservation['client_name']) ?></a><?php if (!empty($reservation['package_request_id'])): ?> <a class="icon-btn" title="Rattachée à la demande d'offre complète : <?= \App\View::e((string) ($reservation['package_title'] ?? '')) ?>" href="/partner/offres/demandes/<?= (int) $reservation['package_request_id'] ?>">📦</a><?php endif; ?><br><small><?= \App\View::e($reservation['client_email']) ?></small></td>
