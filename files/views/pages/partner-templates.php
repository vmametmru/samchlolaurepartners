...
$variables = ['{{nom_client}}','{{email_client}}','{{telephone_client}}','{{dates}}','{{date_arrivee}}','{{date_depart}}','{{adultes}}','{{enfants}}','{{hebergement}}','{{photo_bien}}','{{partenaire}}','{{notes}}','{{message}}','{{signature_photo}}','{{signature_nom}}','{{lien_partenaire}}','{{telephone_partenaire}}'];
?>
