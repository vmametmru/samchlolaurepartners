...
$variables = ['{{nom_client}}','{{email_client}}','{{telephone_client}}','{{dates}}','{{date_arrivee}}','{{date_depart}}','{{adultes}}','{{enfants}}','{{bebes}}','{{hebergement}}','{{partenaire}}','{{notes}}','{{message}}','{{photo_bien}}','{{signature_nom}}','{{signature_photo}}','{{telephone_partenaire}}','{{lien_partenaire}}'];
?>
